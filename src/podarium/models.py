...
class Episode(Base):
    ...
    __table_args__ = (
        UniqueConstraint("feed_id", "guid", name="uq_episodes_feed_guid"),
        # Full-text search over transcripts. Declared here so an autogenerated migration
        # sees it as part of the schema; one that did not dropped it as a stray.
        Index(
            "ix_episodes_transcript_fts",
